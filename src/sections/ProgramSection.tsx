...
const LEVELS = [
  {
    icon: Brain,
    label: 'Блок 1',
    title: 'Ясность и второй мозг',
    text: 'Наводим порядок: чёткая идея вместо хаоса и твоя экспертность, собранная в ИИ-систему, которая всегда под рукой.',
  ...
  },
  {
    icon: Package,
    label: 'Блок 2',
    title: 'Упаковка, которая продаёт',
    text: 'Твоя ценность превращается в понятный оффер и сайт — клиенту сразу ясно, кто ты и зачем ты нужен.',
  ...
  },
  {
    icon: Rocket,
    label: 'Блок 3',
    title: 'Рост на автопилоте',
    text: 'Контент, прогревы и продажи ведут ИИ-агенты — система работает, даже когда тебя нет за компьютером.',
      ...
      <div className="mx-auto max-w-7xl px-5">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Для экспертов, специалистов, консультантов и авторов: у тебя есть идея
            или сильная экспертность — осталось довести её до запуска.
          </p>
        </div>
        ...
        <p className="text-center text-muted-foreground mt-10 text-sm">
          ...
          <span className="text-foreground font-medium">
            Это готовая система под твой проект — собираешь один раз и оставляешь работать.
          </span>
        </p>
      </div>
    </section>
